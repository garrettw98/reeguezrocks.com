...
// Amount = Cumulative Revenue Goal roughly estimated: 45 tix * Price + Addons
window.CROWDFUNDING_TIERS = [
  { id: 1, price: 99,  goal: 4500,  name: 'Event Confirmed', desc: 'Foundation costs covered. The party is ON.' },
  { id: 2, price: 109, goal: 9500,  name: 'Headliner 1 Unlock', desc: 'First major artist announcement.' },
  { id: 3, price: 119, goal: 15000, name: 'Production Upgrade', desc: 'Base audio/visuals secured.' },
  { id: 4, price: 129, goal: 21000, name: 'Headliner 2 Unlock', desc: 'Second major artist announcement.' },
  { id: 5, price: 139, goal: 27500, name: 'The Dome Upgrade', desc: 'Comfy furniture & decor for the late night zone.' },
  { id: 6, price: 149, goal: 34500, name: 'Headliner 3 Unlock', desc: 'Third major artist announcement.' },
  { id: 7, price: 159, goal: 42000, name: 'Art Installations', desc: 'Interactive art funding unlocked.' },
  { id: 8, price: 169, goal: 50000, name: 'Interactive Games', desc: 'Group activities and games unlocked.' },
  { id: 9, price: 179, goal: 58500, name: 'Full Lineup Drop', desc: 'Every artist revealed.' },
  { id: 10, price: 189, goal: 67500, name: 'Production Max Out', desc: 'Lasers, massive sound, full send.' }
];
